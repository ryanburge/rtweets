...
ggplot(thoughts, aes(created_at)) + geom_histogram(color = "black", fill = "firebrick3", bins = 360) + 
  ...
  bar_rb() +
  annotate("text", x = as.Date(2017-10-01 14:02:48), y = 70, label = "Las Vegas", size = 10, family = "Product Sans")
...
ggsave(file="D://rtweets/congress/thoughts_annotate.png", type = "cairo-png", width = 21, height = 15)
